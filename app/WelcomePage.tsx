    ...
    <div className="flex flex-col md:flex-row flex h-screen">
      ...
      <div className="flex-1 flex flex-col justify-start bg-gray-900">
        ...
        <div className="pt-20 px-8 md:px-16">
          <h1 className={`text-5xl md:text-7xl font-extrabold text-white mb-6 ${ANIMATE_CLASS}`} style={{ textShadow: "2px 2px 4px rgba(0,0,0,0.3)", animationDelay: "0.2s" }}>
          Where's Religion?
          </h1>
          {/* Sub-description */}
          ...
          <div className={`mt-8 ${ANIMATE_CLASS}`} style={{ animationDelay: "0.6s" }}>
            <p className={"text-md md:text-md text-gray-500 max-w-xl"}>
