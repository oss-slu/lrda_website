...
const useNoteState = (initialNote: Note | undefined) => {
    ...
    return {
      noteState: { note, editorContent, title, images, time, audio, longitude, latitude, tags, counter },
      noteHandlers: { setNote, setEditorContent, setTitle, setImages, setTime, setAudio, setLongitude, setLatitude, setTags, setCounter },
    };
  };
