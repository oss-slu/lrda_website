...
function AboutIntro() {
  ...
  return (
    <section ref={ref} className="mx-auto max-w-3xl px-4 py-14 sm:py-20" data-reveal={isVisible}>
      ...
      <div
        className={`mt-6 text-base sm:text-lg leading-7 text-muted-foreground max-w-prose ${motionVariants.fadeInUp}`}
        data-reveal={isVisible}
      >
        <p>
...
function TeamGrid() {
  ...
  return (
    <section ref={ref} className="mx-auto max-w-5xl px-4 py-14 sm:py-20" data-reveal={isVisible}>
      ...
      <div
        className={`mt-10 grid grid-cols-2 sm:grid-cols-3 gap-8 justify-items-center ${motionVariants.fadeInUp}`}
        data-reveal={isVisible}
      >
