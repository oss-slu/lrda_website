...
describe("Page Component", () => {
  ...
  it("captures username input", () => {
    render(<Page />);
    fireEvent.change(screen.getByPlaceholderText("you@example.com"), { target: { value: 'testuser' } });
    expect((screen.getByPlaceholderText("you@example.com") as HTMLInputElement).value).toBe('testuser');
  });
  
  it("captures password input", () => {
    render(<Page />);
    fireEvent.change(screen.getByPlaceholderText("••••••••"), { target: { value: 'testpass' } });
    expect((screen.getByPlaceholderText("••••••••") as HTMLInputElement).value).toBe('testpass');
  });
});
