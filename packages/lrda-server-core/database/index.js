...
function currentSettings() {
    const cfg = getConfig()
    const mongoUri = cfg.mongoUri ?? process.env.MONGO_CONNECTION_STRING
    const dbName = cfg.mongodbName ?? process.env.MONGODBNAME
    const collName = cfg.mongodbCollection ?? process.env.MONGODBCOLLECTION
