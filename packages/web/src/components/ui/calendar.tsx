  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: cn(
          "text-muted-foreground w-9 flex-1 select-none rounded-md text-center text-[0.8rem] font-normal",
        ...
        day: cn(
          "group/day relative h-9 w-9 flex-1 select-none p-0 text-center [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data-selected=true]_button]:rounded-r-md",
