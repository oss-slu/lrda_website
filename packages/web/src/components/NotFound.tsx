      ...
      <div className='relative z-10 mx-auto max-w-4xl px-6 py-12 text-center'>
        ...
        >
          <Link to='/' aria-label='Go to home page'>
            <Button className='rounded-full bg-blue-600 px-8 py-3 text-lg font-semibold text-white shadow-lg transition-colors duration-200 hover:bg-blue-500'>
              Go Home
            </Button>
          </Link>
          <Link to='/map' aria-label='Go to map page'>
            <Button
              variant='outline'
