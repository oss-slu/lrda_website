...
import { getCachedLocation } from '@/app/utils/location_cache';
  ...
  return (
    <div className='relative'>
      ...
      >
        ...
        <span>Location</span>
        {locationName && (
          <span className='ml-1 max-w-[150px] truncate text-xs text-gray-500' title={locationName}>
            {locationName}
          </span>
        )}
          ...
          <div className='absolute top-2 left-1/2 z-50 w-4/5 -translate-x-1/2 transform md:w-2/5'>
            <Autocomplete onLoad={auto => setAutocomplete(auto)} onPlaceChanged={onPlaceChanged}>
              <input
                ...
                className='w-full rounded px-4 py-2 shadow-md'
              />
            </Autocomplete>
          </div>
