...
export default function AdminPanel() {
  ...
  const handleUpdateCreator = async (oldRerumId: string, newFirebaseId: string) => {
    try {
      ...
      response.forEach(result => {
        console.log(
          `Note ${result.noteId}: ${result.status} (${result.statusText || result.error})`,
        );
      });
    } catch (error) {
      console.error('Error:', error);
  ...
  return (
    <div className='flex w-screen flex-col justify-center overflow-auto p-4 py-8'>
      <ScrollArea className='w-full max-w-4xl justify-center self-center'>
        <h1 className='text-center text-4xl font-bold'>Admin Panel</h1>
        <h2 className='my-4 text-center text-xl'>
          This is the admin panel. Here you can make modifications to and view elements of the
          backend!
        </h2>
        <Card className='flex flex-col items-center p-5'>
          ...
          : <Tabs defaultValue='note' className='w-full'>
              ...
              <TabsContent value='account' className='w-full p-3'>
                <div className='mb-2 text-lg font-semibold'>View Account Structure here:</div>
                {!userTemplate ?
                ...
                : <pre className='w-full overflow-auto rounded-md border border-gray-300 bg-gray-100 p-2 text-sm'>
              ...
              <TabsContent value='note' className='w-full p-3'>
                <div className='mb-2 text-lg font-semibold'>This is the current schema:</div>
                <pre
                  key={refreshKey}
                  className='w-full overflow-auto rounded-md border border-gray-300 bg-gray-100 p-2 text-sm'
                >
                  {JSON.stringify(noteTemplate, null, 2)}
                </pre>

                <div className='mt-4 text-lg font-semibold'>
                  You can add or remove a field here, however, any change made will only be
                  reflected on the backend and will not be reflected in our codebase. If you add or
                  remove a parameter,
                  <div className='text-lg font-semibold text-red-600'>
                ...
                <Card className='mt-5 flex flex-col items-center p-5'>
                  <Tabs defaultValue='add' className='w-full'>
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              This action cannot be undone. This will permanently add {newValue} as
                              a/an {newValueType} to every single Note Object.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
                    ...
                    <TabsContent value='remove'>
                      <div className='mb-5 mt-4 text-lg font-semibold'>
                        Select the parameter that you would like to permanently remove!
                      </div>
                      <Select
                        onValueChange={val => {
                          setDeleteValue(val);
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              ...
                              {deleteValue} from every single Note Object.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
                            <AlertDialogCancel>Cancel</AlertDialogCancel>
              ...
              <TabsContent value='uid' className='w-full p-3'>
                <div className='mb-2 text-lg font-semibold'>Add UID to Rerum ID</div>
                <Input
                  className='mb-2'
              ...
              <TabsContent value='updateCreator' className='w-full p-3'>
                <div className='mb-2 text-lg font-semibold'>Update Creator UID for All Notes</div>
                <Input
                  className='mb-2'
                  placeholder='Old Rerum ID'
                  value={oldRerumId}
                ...
                <Input
                  ...
                  onChange={e => setNewFirebaseId(e.target.value)}
                />
                <Button onClick={() => handleUpdateCreator(oldRerumId, newFirebaseId)}>
                  Submit
                </Button>
