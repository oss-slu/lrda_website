...
const SearchBarMap: React.FC<SearchBarMapProps> = ({ onSearch, onNotesSearch, isLoaded, filteredNotes }) => {
  ...
  const combinedResults = useMemo((): CombinedResult[] => {
    ...
    results.sort((a, b) => {
      const textA = "description" in a ? a.description || "" : a.title && typeof a.title === "string" ? a.title : "";
      const textB = "description" in b ? b.description || "" : b.title && typeof b.title === "string" ? b.title : "";
